...
String attend_uname = request.getParameter("attend_uname");
...
try {
   ...
   pre.setString(1, attend_uno); pre.setString(2, attend_uname);
   pre.setString(3, attend_rname); pre.setString(4, cperiod); 
   pre.setString(5, Vtotalday); pre.setString(6, Vuseday);
   pre.setString(7, Vrestday);
   pre.executeUpdate();
%>
<script>
